    ...
    return (
        <div className="container mt-4">
            <div className="card p-4">
                <h4 className="mb-3 text-warning text-center">Personal Loan Calculator</h4>
                <div className="row">
                    {/* Input Controls */}
                    <div className="col-md-6">
                        {[
                            { label: "Personal Loan Amount (Rs)", values: loanAmounts, setter: setLoanIndex, index: loanIndex },
